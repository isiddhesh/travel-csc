...
<body data-spy="scroll" data-target=".navbar" data-offset="10">
    ...
    <div id="Home">
		...
		<div class="survey">
			...
			<div class="surveyBtn"><a href="survey.php"><button class="yellowBtn">Find a Place</button></a></div>
		</div>
	</div> <!--home ends-->
  ...
  ?>
    ...
    <!--footer-->
    	...
    	<div class="text-center py-3">
			...
			<div class="footer-copyright text-center py-3 madeby" font style="color: #111111;">
    		Made by Siddhesh Patil, Ritwik Bhanot</font>
    	</div>
			<div class="footer-copyright text-center py-3 madeby" font style="color: #111111;">
    		Made by Siddhesh Patil, Ritwik Bhanot</font>
    	</div>
    	<div class="footer-copyright text-center py-3 madeby">
    		Made by<font style="color: #ffc312;"> Siddhesh Patil, Ritwik Bhanot</font>
    	</div>
			<div class="footer-copyright text-center py-3 madeby" font style="color: #111111;">
    		Made by Siddhesh Patil, Ritwik Bhanot</font>
    	</div>
